<?php
  ...
  use PHPMailer\PHPMailer\Exception;
    ...
    class Mensagem{
        ...
        public $status = array('codigo_status'=>null, 'desicao_status'=>'');
...
try {
    ...
    $mail->Host       = 'smtp.gmail.com';                     //Servidor publico da google de smtp
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'email';                     //SMTP username
    $mail->Password   = 'senha_aplicativo do google';                               //SMTP password
   ...
   // $mail->addAttachment('/var/tmp/file.tar.gz');         //Add attachments
    ...
    $mensagem->status['descricao_status'] = 'Não foi possível enviar esté email! Por favor tente novamente mais tarde.'. " Detalhes do erro: {$mail->ErrorInfo}";
